...
2. Choose your components and install path
3. Download and run the generated `install_bond.bat`
4. Start BOND with `start_bond.bat`
5. Add the MCP config from the wizard to your Claude setup
